...
export default function SignIn() {
  ...
  useEffect(() => {
    ...
    const checkoutCompleted = document.cookie.includes("whop_checkout_completed=true")
    setIsCheckoutCompleted(checkoutCompleted)
  }, [])
    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-card p-8 shadow-lg">
        ...
        <div className="mt-8 space-y-6">
          <Button onClick={handleGoogleSignIn} className="w-full flex items-center justify-center" variant="outline">
